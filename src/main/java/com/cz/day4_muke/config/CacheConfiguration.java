...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.cz.day4_muke.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.cz.day4_muke.repository.UserRepository.USERS_BY_EMAIL_CACHE);
